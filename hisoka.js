/**
   * Create By M. Dandi Saputra
   * Contact Me on wa.me/+6281352445558
   * Follow https://github.com/gapfinderindonesia
   * Follow https://instagram.com/gapfinderindonesia
*/
...
module.exports = hisoka = async (hisoka, m, chatUpdate, store) => {
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await hisoka.setStatus(`${'RoycoBot'} | Runtime : ${runtime(uptime)}`)
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            break
            case 'sc': {
                m.reply('Script : https://github.com/gapfinderindonesia\n\n Dont Forget Give Star\n\nDonate : 085251283421 (Dana)\nSaweria : https://saweria.co/DandiSaputra\nPaypal : https://www.paypal.me/gapfinderindonesia\n\n Dont Forget Donate')
            }
            break
            case 'chat': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, jawab, 'RoycoBot', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, jawab, 'RoycoBot', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Group`, 'RoycoBot', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Edit Info`, 'RoycoBot', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `Mode Antilink`, 'RoycoBot', m)
                }
             }
             break
             case 'mute': {
                ...
                m.reply(`${'RoycoBot'} telah di mute di group ini !`)
                } else if (args[0] === "off") {
                if (!db.data.chats[m.chat].mute) return m.reply(`Sudah Tidak Aktif Sebelumnya`)
                db.data.chats[m.chat].mute = false
                m.reply(`${'RoycoBot'} telah di unmute di group ini !`)
                } else {
                 let buttons = [
                        { buttonId: 'mute on', buttonText: { displayText: 'ON' }, type: 1 },
                        { buttonId: 'mute off', buttonText: { displayText: 'OFF' }, type: 1 }
                    ]
                    await hisoka.sendButtonText(m.chat, buttons, `Mute Bot`, 'RoycoBot', m)
                }
             }
             break
            ...
            case 'bcgc': case 'bcgroup': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                      ...
                      hisoka.send5ButImg(i, txt, 'RoycoBot', global.thumb, btn)
                    }
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      hisoka.send5ButImg(yoi, txt, 'RoycoBot', global.thumb, btn)
		}
...
case 'stext': case 'stickertext': case 'stikertext': {
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            hisoka.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${'RoycoBot'}.mp3`}, { quoted : m })
            }
            break
...
Lihat list Pesan Dengan ${prefix}listmsg`)
	    ...
	    case 'anonymous': {
                ...
                hisoka.sendButtonText(m.chat, buttons, `\`\`\`Hi ${await hisoka.getName(m.sender)} Welcome To Anonymous Chat\n\nKlik Button Dibawah Ini Untuk Mencari Partner\`\`\``, 'RoycoBot', m)
            }
			break
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, 'RoycoBot', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await hisoka.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, 'RoycoBot', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await hisoka.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, 'RoycoBot', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await hisoka.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, 'RoycoBot', m)
                }
                break
            }
...
case 'donasi': case 'donate': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/0tYC6M7/IMG-20220617-142354.jpg' }, caption: `Silahkan Scan Kode QR Diatas Untuk Donasi` }, { quoted: m })
            }
            break
case 'gopay': {
                hisoka.sendMessage(m.chat, { image: { url: 'coming soon' }, caption: `GOPAY` }, { quoted: m })
            }
            break
case 'dana': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://i.ibb.co/0tYC6M7/IMG-20220617-142354.jpg' }, caption: `DANA` }, { quoted: m })
            }
            break
case 'qris': {
                hisoka.sendMessage(m.chat, { image: { url: 'coming soon' }, caption: `QRIS ALL PAYMENT` }, { quoted: m })
            }
            break
...
let btn = [{
                ...
                hisoka.send5ButImg(m.chat, anu, 'RoycoBot', global.thumb, btn)
            }
            break
case 'sewabot': {
	anu = `╭──「 *_SEWA BOT BY RoycoBot_* 」
│❏ ➪ _1 MINGGU : 1K_
│❏ ➪ _1 BULAN : 5K_
│❏ ➪ _PERMANEN : 10k_
╰────
...
╰──── 
╭─[ *MINAT CHAT📌*]
│❏ ➪ 🪀 _wa.me/+6281352445558?text=SEWA+BOT_
╰────
╭─[ *PAYMENT💰*]
│❏ ➪ _GOPAY_
│❏ ➪ _DANA_
...
╰────`
            ...
            break
  case 'menu': {
	anu = `Hai Kak ${pushname}\n\nSaya Adalah RoycoBot, Bot Ini Memakai Program Multi Device Beta Dari WhatsApp.\n\nJadi Jika Kamu Menemukan Bug Atau Kesalahan Silahkan Laporkan Kepada Owner Agar Segera Di Perbaiki.\n\nTerima Kasih.`
              let btn = [{
                                urlButton: {
                                    displayText: 'IG OWNER',
                                    url: 'https://instagram.com/gapfinderindonesia'
                                }
                            }, {
                                quickReplyButton: {
                                    displayText: 'RULES',
...
│
│⭔ Diri Sendiri
│⭔ M. Dandi Saputra (Pemilik Base)
│⭔ M. Dandi Saputra (Pemilik Bot)
│⭔ Penyedia Module (Royco)
│⭔ Penyedia Rest Api (Royco)
│
└───────⭓`
let btn = [{
                                urlButton: {
